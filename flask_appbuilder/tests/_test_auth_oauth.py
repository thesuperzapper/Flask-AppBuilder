...
class OAuthRegistrationRoleTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.config["OAUTH_PROVIDERS"] = []  # can be empty, because we dont use the external providers in tests
    ...
    def test__unregistered__single_role(self):
        """
        OAUTH: test login flow for - unregistered user - single role mapping
        """
